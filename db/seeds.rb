...
veg_omelette = Recipe.create(name: "Vegetable Egg Omelette", description: "3 Egg Omelette with peppers, spinach and mushrooms", preptime: 10, category: 'breakfast', subcategory: 'egg', picture: 'veg-omlette.jpeg')
...
egg_mushroom = Recipe.create(name: "Egg & Garlic Mushroom Toast", description: "Garlic fried mushrooms and scrabled egg od low-carb bread", preptime: 14, category: 'breakfast', subcategory: 'egg', picture: '')
nut_toast = Recipe.create(name: "Almond Butter and Banana Toast", description: "Almond butter and 1 banana on low-carb toast with some honey", preptime: 10, category: 'breakfast', subcategory: 'bread', picture: '')
berry_smoothie = Recipe.create(name: "Berry Smoothie", description: "Thick smoothie made with blueberries, raspberries and strawberries. ", preptime: 11, category: 'breakfast', subcategory: 'smoothie', picture: '')
(name: "", description: "", preptime: 17, category: 'breakfast', subcategory: 'egg', picture: '')
