...
egg_mushroom = Recipe.create(name: 'Egg & Garlic Mushroom Toast', description: 'Garlic fried mushrooms and scrabled egg od low-carb bread', preptime: 14, category: 'breakfast', subcategory: 'egg', picture: 'egg-mushroom.jpeg')
nut_toast = Recipe.create(name: 'Almond Butter and Banana Toast', description: 'Almond butter and 1 banana on low-carb toast with some honey', preptime: 10, category: 'breakfast', subcategory: 'bread', picture: 'nut-toast.jpeg')
...
egg_muffin = Recipe.create(name: 'Egg Muffins', description: 'Egg muffins made with eggs, spinach, peppers and tomatos', preptime: 20, category: 'breakfast', subcategory: 'egg', picture: 'egg-muffin.jpeg')
